...
#define TREE_LEVELS                      50u  /*!< The number of levels in the tree */
#define MT_AL_MAX_ELEMS              20194304u  /*!< The maximum number of elements in a Merkle Tree array list. Essential for integer overflow protection! */
